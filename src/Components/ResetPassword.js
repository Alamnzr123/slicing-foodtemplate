    ...
    <div className="col-md-6 px-0">
        ...
        <div className="container SignIn_container__k8cC9">
            <form className="SignIn_form__ZAIHo">
                <div className="fp">
                    <div className="InputAuth_box__SHTUc"><label className="form-label" for="email">Code 6 Digit</label><input className="form-control" placeholder="" type="email" name="email" id="email" required=""/></div>
                    <button className="btn SignIn_btn_gold__YVLeP disabled" type="submit">ResetPassword</button>
                </div>
            </form>
        </div>
    </div>
