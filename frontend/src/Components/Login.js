        ...
        <div className="container SignIn_container__k8cC9">
            <form className="SignIn_form__ZAIHo" onSubmit={(e) => onSubmit(e)}><span>Welcome</span><br/><p >Log in into your existing account.</p>
                <div>
                    ...
                    <div className="InputAuth_box__SHTUc_checkbox"><input type="checkbox" id="terms" name="terms" onChange={(e) => onChangeInput(e.target.checked, "terms")}  value="checkbox"/><label for="checkbox"> I Aggree to term & Conditions</label></div>
