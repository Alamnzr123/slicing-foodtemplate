            ...
            <div className="col-md-6 px-0">
                ...
                <div className="container SignIn_container__k8cC9">
                    <form method="post" encType='multipart/form-data' onSubmit={(e) => onSubmit(e)} className="SignIn_form__ZAIHo"><span>Let's Get Started !</span><br/><p >Create new account to access all features</p>
                        <div>
                        <div className="InputAuth_box__SHTUc"><label className="form-label" for="name">Name</label><input className="form-control" placeholder="Name" type="text" name="name" id="name" onChange={(e) => onChangeInput(e.target.value, "name")} required=""/></div>
                            <div className="InputAuth_box__SHTUc"><label className="form-label" for="email">E-mail Address*</label><input className="form-control" placeholder="Enter your email address" type="email" onChange={(e) => onChangeInput(e.target.value, "email")} name="email" id="email" required=""/></div>
